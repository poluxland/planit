...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('feedbacks');

// This file contains the logic of every route in Forest Admin for the collection feedbacks:
...
// Create a Feedback
router.post('/feedbacks', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Feedback
router.put('/feedbacks/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Feedback
router.delete('/feedbacks/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/feedbacks', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Feedbacks
router.get('/feedbacks/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Feedback
router.get('/feedbacks/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Feedbacks
router.get('/feedbacks.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
