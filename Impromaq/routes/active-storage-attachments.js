...
const { active_storage_attachments } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('active_storage_attachments');

// This file contains the logic of every route in Forest Admin for the collection active_storage_attachments:
...
// Create a Active Storage Attachment
router.post('/active_storage_attachments', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Active Storage Attachment
router.put('/active_storage_attachments/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Active Storage Attachment
router.delete('/active_storage_attachments/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Active Storage Attachments
router.get('/active_storage_attachments', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Active Storage Attachments
router.get('/active_storage_attachments/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Active Storage Attachment
router.get('/active_storage_attachments/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Active Storage Attachments
router.get('/active_storage_attachments.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
