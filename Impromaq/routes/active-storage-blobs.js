...
const { active_storage_blobs } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('active_storage_blobs');

// This file contains the logic of every route in Forest Admin for the collection active_storage_blobs:
...
// Create a Active Storage Blob
router.post('/active_storage_blobs', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Active Storage Blob
router.put('/active_storage_blobs/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Active Storage Blob
router.delete('/active_storage_blobs/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Active Storage Blobs
router.get('/active_storage_blobs', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Active Storage Blobs
router.get('/active_storage_blobs/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Active Storage Blob
router.get('/active_storage_blobs/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Active Storage Blobs
router.get('/active_storage_blobs.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
