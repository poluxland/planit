...
// Get a list of Tasks
router.get('/tasks', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Task
router.get('/tasks/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
