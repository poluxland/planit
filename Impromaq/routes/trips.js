...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('trips');

// This file contains the logic of every route in Forest Admin for the collection trips:
...
// Create a Trip
router.post('/trips', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Trip
router.put('/trips/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Trip
router.delete('/trips/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Trips
router.get('/trips', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Trips
router.get('/trips/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Trip
router.get('/trips/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Trips
router.get('/trips.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
