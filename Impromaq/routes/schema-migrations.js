...
const { schema_migrations } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('schema_migrations');

// This file contains the logic of every route in Forest Admin for the collection schema_migrations:
...
router.post('/schema_migrations', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/schema_migrations/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/schema_migrations/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/schema_migrations', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/schema_migrations/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/schema_migrations/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/schema_migrations.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
