...
<html lang="en">
<head>
    <title>Code coverage report for services/has-many-getter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">services</a> has-many-getter.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  function findQuery(queryOptions) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!queryOptions) { <span class="cstat-no" title="statement not covered" >queryOptions = {}; </span>}
&nbsp;
    return orm.findRecord(model, params.recordId, {
      ...
      .then(record =&gt; ((record &amp;&amp; record[params.associationName]) || <span class="branch-2 cbranch-no" title="branch not covered" >[])</span>);
  }
&nbsp;
  function getCount() {
    return model.count({
