...
<html lang="en">
<head>
    <title>Code coverage report for services/resource-creator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">services</a> resource-creator.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (model.associations) {
...
<span class="cstat-no" title="statement not covered" >          promises.push(recordCreated[`set${_.upperFirst(name)}`](params[name], { save: false }));</span>
        }
      });
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          throw new ErrorHTTP422(error.message);</span>
        }))
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (model.associations) {
          _.forOwn(model.associations, (association, name) =&gt; {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (association.associationType === 'HasOne') {
<span class="cstat-no" title="statement not covered" >              promisesAfterSave.push(record[`set${_.upperFirst(name)}`](params[name]));</span>
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (['BelongsToMany', 'HasMany'].indexOf(association.associationType) &gt; -1) {
