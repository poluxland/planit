...
<html lang="en">
<head>
    <title>Code coverage report for services/apimap-field-builder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">services</a> apimap-field-builder.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>41/68</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (column.allowNull === false) {
<span class="cstat-no" title="statement not covered" >      validations.push({</span>
        type: 'is present',
      });
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (column.validate.min) {
<span class="cstat-no" title="statement not covered" >      validations.push({</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (column.validate.max) {
<span class="cstat-no" title="statement not covered" >      validations.push({</span>
        type: 'is less than',
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (column.validate.isBefore) {
<span class="cstat-no" title="statement not covered" >      validations.push({</span>
        type: 'is before',
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (column.validate.isAfter) {
<span class="cstat-no" title="statement not covered" >      validations.push({</span>
        type: 'is after',
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isArray(length) &amp;&amp; !_.isNull(length[0]) &amp;&amp; !_.isUndefined(length[0])) {
        validations.push({
          type: 'is longer than',
          value: length[0],
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (length[1]) {
          validations.push({
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (column.validate.contains) {
<span class="cstat-no" title="statement not covered" >      validations.push({</span>
        type: 'contains',
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (column.validate.is &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!_.isArray(column.validate.is))</span> {
      const value = <span class="cstat-no" title="statement not covered" >column.validate.is.args || column.validate.is;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      validations.push({</span>
        type: 'is like',
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (schema.type === 'Enum') {
<span class="cstat-no" title="statement not covered" >      schema.enums = column.values;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isRequired()) {
<span class="cstat-no" title="statement not covered" >      schema.isRequired = true;</span>
    }
&nbsp;
...
&nbsp;
    if (!_.isNull(column.defaultValue) &amp;&amp; !_.isUndefined(column.defaultValue)) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (isDefaultValueFunction) {
        schema.isRequired = false;
      // NOTICE: Do not use the primary keys default values to prevent issues with UUID fields
      //         (defaultValue: DataTypes.UUIDV4).
      } else <span class="cstat-no" title="statement not covered" >if (!_.includes(_.keys(model.primaryKeys), column.fieldName)) {</span>
<span class="cstat-no" title="statement not covered" >        schema.defaultValue = column.defaultValue;</span>
      }
    }
&nbsp;
