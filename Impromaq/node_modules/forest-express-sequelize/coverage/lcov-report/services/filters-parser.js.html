...
<html lang="en">
<head>
    <title>Code coverage report for services/filters-parser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">services</a> filters-parser.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>35/63</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { BaseFiltersParser, BaseOperatorDateParser, Schemas } from 'forest-express';
...
&nbsp;
  this.formatOperator = <span class="fstat-no" title="function not covered" >(o</span>perator) =&gt; {
<span class="cstat-no" title="statement not covered" >    switch (operator) {</span>
      case 'not':
<span class="cstat-no" title="statement not covered" >        return this.OPERATORS.NOT;</span>
      case 'greater_than':
      case 'after':
<span class="cstat-no" title="statement not covered" >        return this.OPERATORS.GT;</span>
      case 'less_than':
      case 'before':
<span class="cstat-no" title="statement not covered" >        return this.OPERATORS.LT;</span>
      case 'contains':
      case 'starts_with':
      case 'ends_with':
<span class="cstat-no" title="statement not covered" >        return this.OPERATORS.LIKE;</span>
      case 'not_contains':
<span class="cstat-no" title="statement not covered" >        return this.OPERATORS.NOT_LIKE;</span>
      case 'present':
      case 'not_equal':
<span class="cstat-no" title="statement not covered" >        return this.OPERATORS.NE;</span>
      case 'blank':
      case 'equal':
<span class="cstat-no" title="statement not covered" >        return this.OPERATORS.EQ;</span>
      default:
<span class="cstat-no" title="statement not covered" >        throw new NoMatchingOperatorError();</span>
    }
  };
&nbsp;
  this.formatValue = <span class="fstat-no" title="function not covered" >(o</span>perator, value) =&gt; {
<span class="cstat-no" title="statement not covered" >    switch (operator) {</span>
      case 'not':
      case 'greater_than':
      case 'less_than':
