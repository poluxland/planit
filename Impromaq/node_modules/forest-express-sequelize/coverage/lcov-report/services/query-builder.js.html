...
<html lang="en">
<head>
    <title>Code coverage report for services/query-builder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">services</a> query-builder.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  this.getSkip = () =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (hasPagination()) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Database.isMSSQL(opts) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_.includes([idField, `-${idField}`], params.sort))</span> {
        const sequelizeVersion = <span class="cstat-no" title="statement not covered" >opts.sequelize.version;</span>
<span class="cstat-no" title="statement not covered" >        if (sequelizeVersion !== '4.4.2-forest') {</span>
...
&nbsp;
      if (params.sort.indexOf('.') !== -1) {
        ...
        const column = getReferenceField(
          Schemas.schemas,
          (aliasSchema || <span class="branch-1 cbranch-no" title="branch not covered" >schema)</span>,
          associationName,
          fieldName,
        );
