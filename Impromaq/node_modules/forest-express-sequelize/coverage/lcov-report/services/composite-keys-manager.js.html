...
<html lang="en">
<head>
    <title>Code coverage report for services/composite-keys-manager.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">services</a> composite-keys-manager.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    primaryKeyValues.forEach((key, index) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (key === 'null') { <span class="cstat-no" title="statement not covered" >primaryKeyValues[index] = null; </span>}
    });
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (primaryKeyValues.length === _.keys(model.primaryKeys).length) {
...
&nbsp;
    _.keys(model.primaryKeys).forEach((primaryKey, index) =&gt; {
      // NOTICE: Prevent liana to crash when a composite primary keys is null,
      //         this behaviour should be avoid instead of fixed.
      <span class="missing-if-branch" title="if path not taken" >I</span>if (record[primaryKey] === null) {
<span class="cstat-no" title="statement not covered" >        record[primaryKey] = 'null';</span>
      }
      if (index === 0) {
