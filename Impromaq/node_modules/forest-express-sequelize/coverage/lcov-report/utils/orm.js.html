...
<html lang="en">
<head>
    <title>Code coverage report for utils/orm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">utils</a> orm.js
    </h1>
    <div class='clearfix'>
...
<a name='L43'></a><a href='#L43'>43</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
const getVersion = (sequelize) =&gt; {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (version &amp;&amp; version[0]) {
    return version[0];
  }
...
const findRecord = (model, recordId, options) =&gt; {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (model.findByPk) {
    return model.findByPk(recordId, options);
  }
<span class="cstat-no" title="statement not covered" >  return model.findById(recordId, options);</span>
};
&nbsp;
