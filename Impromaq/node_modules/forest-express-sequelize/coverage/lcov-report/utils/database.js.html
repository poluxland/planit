...
<html lang="en">
<head>
    <title>Code coverage report for utils/database.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">utils</a> database.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">function optionsInvalid(options) {
...
exports.isMySQL = (options) =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (optionsInvalid(options)) { <span class="cstat-no" title="statement not covered" >return false; </span>}
