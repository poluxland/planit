function ApimapFieldTypeDetector(column, options) {
  ...
  this.perform = function () {
    if (column.type instanceof DataTypes.STRING || column.type instanceof DataTypes.TEXT || column.type instanceof DataTypes.UUID || column.type instanceof DataTypes.UUIDV1 || column.type instanceof DataTypes.UUIDV4 || DataTypes.CITEXT && column.type instanceof DataTypes.CITEXT || column.type === 'citext') {
