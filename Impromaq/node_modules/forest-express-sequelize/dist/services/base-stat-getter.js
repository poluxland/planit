      ...
      params.filters.forEach(function (filter) {
        ...
        if (field.indexOf(':') !== -1) {
          ...
          if (associationSchema) {
            var associationField = _.find(associationSchema.fields, function (field) {
              return field.field === fieldSplited[1];
            });
        ...
        var condition = {};
        condition[field] = new OperatorValueParser(options).perform(model, filter.field, filter.value, params.timezone);
